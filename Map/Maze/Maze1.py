...
class MapGenerator:
    ...
    def generate_rectangle(self, img, density, start=None, end=None):
        ...
        vertical_walls = [
            ...
            (40, 120, wall_thickness, 104),  
            (120, 40, wall_thickness, 144),  
            (200, 80, wall_thickness, 144) 
        ]

        horizontal_walls = [
            (0, 80, 100, wall_thickness), 
            (60, 160, 80, wall_thickness),  
            (140, 40, 84, wall_thickness),  
            (120, 120, 100, wall_thickness)  
        ]
...
class GUI:
    ...
    def generate(self):
        try:
            ...
            messagebox.showinfo("Success", f"Generated {num} maps and saved to Desktop/5 folder")

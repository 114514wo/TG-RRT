...
class MapGenerator:
    ...
    def generate_rectangle(self, img, density, start=None, end=None):
        ...
        vertical_walls = [
            ...
            (40, 140, wall_thickness, 84), 
            (100, 40, wall_thickness, 144),  
            (160, 20, wall_thickness, 124),  
            (220, 60, wall_thickness, 164)  
        ]

        horizontal_walls = [
            (0, 60, 80, wall_thickness),  
            (60, 140, 60, wall_thickness),  
            (120, 40, 64, wall_thickness),  
            (100, 100, 80, wall_thickness),  
            (140, 180, 100, wall_thickness),  
            (180, 80, 44, wall_thickness) 
        ]
